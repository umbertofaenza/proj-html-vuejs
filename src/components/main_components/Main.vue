    ...
    <div id="jumbotron">
      <div class="container h-100 d-flex align-items-center">
        <div class="jumbotron-content">
          ...
          <!-- title -->
          <div class="jumbotron-title">Resident Evil 3 Remake</div>
          <!-- button -->
          <div class="jumbotron-btn">Shop Now</div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="showcase-divider d-flex justify-content-center">
        ...
        <div class="box d-flex align-items-center">
          <!-- box icon -->
          <div class="box__icon">
            <font-awesome-icon :icon="['fas', 'truck']" size="2x" />
          </div>
          <!-- box text -->
          <div class="box__text">
        ...
        <div class="box d-flex align-items-center">
          <!-- box icon -->
          <div class="box__icon">
            <font-awesome-icon :icon="['fas', 'sack-dollar']" size="2x" />
          </div>
          <!-- box text -->
          <div class="box__text">
      ...
      <div class="container d-flex align-items-center">
        ...
        >
          ...
          <div class="quote">
            ...
            Blanditiis, voluptas. Magnam quod ad maiores maxime. Lorem ipsum
            dolor sit amet consectetur adipisicing elit. Ea sapiente, ipsa neque
            voluptatum at omnis. Lorem ipsum dolor sit amet."
          </div>
        </div>
      </div>
    </div>
